...
class DuePaymentScreen extends StatefulWidget {
  ...
  @override
  State<DuePaymentScreen> createState() => _ActiveUserScreenState();
}

class _ActiveUserScreenState extends State<DuePaymentScreen> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<CustomerController>(
      builder: (active) => Scaffold(
        ...
        appBar: const CustomAppBar(title: 'Due payment list'),
        body: SafeArea(
          child: Column(
            children: [
                              ...
                              children: [
                                ...
                                Expanded(child: Column( crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    ...
                                    const SizedBox(height: 2,),
                                    Text(active.searchActiveAllCustomer[index].dueDate ?? '', style: robotoRegular.copyWith(color: MyColor.getRedColor(), fontSize: 14),)
                              ...
                              children: [
                                ...
                                Expanded(child: Column( crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    ...
                                    const SizedBox(height: 2,),
                                    Text(active.allActiveCustomer[index].dueDate ?? '', style: robotoRegular.copyWith(color: MyColor.getRedColor(), fontSize: 14),)
