...
class CustomPopupMenuController extends GetxController implements GetxService {
...
class CustomPopupMenuScreen extends StatefulWidget {
  ...
  @override
  State<CustomPopupMenuScreen> createState() => _CustomPopupMenuScreenState();
}

class _CustomPopupMenuScreenState extends State<CustomPopupMenuScreen> {
